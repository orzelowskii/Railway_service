...
public class ToxicMaterialsWagon extends HeavyFreightWagon{

    private int radiationLevel;
    private boolean isDangerous;

    public ToxicMaterialsWagon(String sender, int weightNet, int weightGross, security level) {
        super(sender, weightNet, weightGross, level);
    }

    public ToxicMaterialsWagon() {
        super.id = counter;
